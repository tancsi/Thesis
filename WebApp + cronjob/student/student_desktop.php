...
<body>
		...
		<h1>Trips</h1>
		 <div class="form-group" id="adjustHeight">
			<div class="form-group row">
				<div class="col-md-6" id="routes-select-container">
	...
	$(document).ready(function() {
		...
		function get_trips(){
			...
			$.ajax({
				url: 'get_student_routes.php',
				type: 'POST',
				data: { user_id: '<?php echo $username; ?>' },
				dataType: 'json',
				success: function(data) {
					...
					if (data.length === 0) {
						...
						routeOptions.push({
							id: '',
							text: 'Trips of ' + '<?php echo $username; ?>',
							disabled: true,
							selected: true
						});
						...
						data.forEach(function(route) {
							...
							routeOptions.push({
								id: route.trip_num,
								text: 'Trip ' + route.trip_num + ' (' + formattedDate + ')'+' / '+route.first_name+' '+route.last_name+' ('+route.username+')'
							});
						});
					}
					$('#routes-select').select2({
		...
		function getTotaltime(){
			return new Promise(function(resolve, reject) {			
				$.ajax({
					url: '..//teacher/get_total_time.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>' },
					dataType: 'json',
					success: function(data){
		...
		function getTotalDistance(){
			return new Promise(function(resolve, reject) {
				...
				$.ajax({
					url: '..//teacher/get_total_distance.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>' },
					dataType: 'json',
					success: function(data){
		...
		function getTotalDistanceHighway(){
			return new Promise(function(resolve, reject) {
				
				$.ajax({
					url: '..//teacher/get_total_distance_highway.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>' },
					dataType: 'json',
					success: function(data){
		...
		function getOneTripDetails(selectedTrip){
			return new Promise(function(resolve, reject) {			
				$.ajax({
					url: '..//teacher/get_one_trip_details.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>', trip_num:selectedTrip},
					dataType: 'json',
					success: function(data){
						if (data.length != 0) {
							$('#unique-h1').show();
		...
		function getOneTripDistance(selectedTrip){
			return new Promise(function(resolve, reject) {			
				$.ajax({
					url: '..//teacher/get_one_trip_distance.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>', trip_num:selectedTrip},
					dataType: 'json',
					success: function(data){
		...
		function getOneTripDistanceHighway(selectedTrip){
			return new Promise(function(resolve, reject) {			
				$.ajax({
					url: '..//teacher/get_one_trip_distance_highway.php',
					type: 'POST',
					data: { user_id:'<?php echo $username; ?>', trip_num:selectedTrip},
					dataType: 'json',
					success: function(data){
		...
		$('#routes-select').on('change', function() {
			var selectedTrip =$(this).val();		
			 getTotaltime().then(function() {
				return getTotalDistance();
			}).then(function(){
				return getTotalDistanceHighway();
			}).then(function(){
				return getOneTripDetails(selectedTrip);
			}).then(function() {
				return getOneTripDistance(selectedTrip);
			}).then(function(){
				return getOneTripDistanceHighway(selectedTrip);
			}).then(function(){
				return get_trip(selectedTrip);
